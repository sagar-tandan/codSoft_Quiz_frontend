...
function ProtectedRoute({ children }) {
  ...
  const adminMenu = [
    {
      title: "Home",
      paths: ["/admin", "/user/write-quiz/:id"],
      icon: <i className="ri-home-line"></i>,
      onClick: () => navigate("/admin"),
    },
    {
      title: "Quizs",
      paths: ["/admin/quizs", "/admin/quizs/add", "/admin/quizs/edit/:id"],
  ...
  const getIsActiveOrNot = (paths) => {
    if (paths.includes(activeRoute)) {
      ...
      if (
        activeRoute.includes("/admin/quizs/edit") &&
        paths.includes("/admin/quizs")
      ) {
        return true;
      }
      if (
        activeRoute.includes("/user/write-quiz/:id") &&
        paths.includes("/user/write-quiz/:id")
      ) {
        return true;
      }
      return false;
